...
class DarkColors implements ThemeColorsBase<Partial<ThemeRichColor>> {
  ...
  gradients = {
    brandHorizontal: ' linear-gradient(270deg, #1DD1A1 0%, #0099FF 100%);',
    brandVertical: 'linear-gradient(0.01deg, #1DD1A1 0.01%, #0099FF 99.99%);',
  };
...
class LightColors implements ThemeColorsBase<Partial<ThemeRichColor>> {
  ...
  gradients = {
    brandHorizontal: 'linear-gradient(90deg, #1DD1A1 30%, #0099FF 99%);',
    brandVertical: 'linear-gradient(0.01deg, #1DD1A1 -31.2%, #0099FF 113.07%);',
  };
