...
// gradients
$brand-gradient-horizontal: linear-gradient(to right, #1DD1A1 30%, #0099FF 99%);
$brand-gradient-vertical: linear-gradient(to right, #1DD1A1 30%, #0099FF 99%);
...
$checkbox-checked-bg: linear-gradient(0deg, #1DD1A1 30%, #0099FF 99%);
...
// toggle-group
$button-toggle-group-btn-active-bg: linear-gradient(90deg, #1DD1A1 30%, #0099FF 99%);
