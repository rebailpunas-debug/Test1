...
export const cardStyle = stylesFactory((theme: GrafanaTheme, complete: boolean) => {
  const completeGradient = 'linear-gradient(to right, #1DD1A1 0%, #0099FF 100%)';
  const darkThemeGradients = complete ? completeGradient : 'linear-gradient(to right, #1DD1A1 0%, #0099FF 100%)';
  const lightThemeGradients = complete ? completeGradient : 'linear-gradient(to right, #1DD1A1 0%, #0099FF 100%)';
