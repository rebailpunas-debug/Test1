...
import * as imageSavePanel from 'app/plugins/panel/imagesave/module';
...
const flowchartingPanel = async () =>
  await import(/* webpackChunkName: "flowchartingPanel" */ 'app/plugins/panel/flowcharting/module');
...
const builtInPlugins: any = {
  ...
  'app/plugins/panel/flowcharting/module': flowchartingPanel,
  'app/plugins/panel/imagesave/module': imageSavePanel,
};
